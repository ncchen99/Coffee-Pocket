-- Coffee Pocket — Filter out permanently_closed and temporarily_closed cafes from frontend searches
...
-- ------------------------------------------------------------------
-- Redefine cafes_search with correct business status filtering
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- Redefine cafes_search_count with correct business status filtering
-- ------------------------------------------------------------------
