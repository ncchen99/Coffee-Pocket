...

{
  "signals": [
    {
      "type": "socket_available" | "study_friendly" | "discussion_friendly" | "time_limit" | "pet_friendly" | "reservable" | "group_chat_friendly" | "noise_level" | "wifi_quality" | "seating_availability",
